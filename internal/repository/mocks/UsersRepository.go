...
import (
	...
	repository "github.com/kenplix/url-shrtnr/internal/repository"
)
...
func (_m *UsersRepository) ChangeEmail(ctx context.Context, schema repository.ChangeEmailSchema) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, repository.ChangeEmailSchema) error); ok {
		r0 = rf(ctx, schema)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *UsersRepository) ChangePassword(ctx context.Context, schema repository.ChangePasswordSchema) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, repository.ChangePasswordSchema) error); ok {
		r0 = rf(ctx, schema)
	} else {
		r0 = ret.Error(0)
	}
