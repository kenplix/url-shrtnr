...
func (_m *UsersService) SignIn(ctx context.Context, input usecase.UserSignInInput) (auth.Tokens, error) {
	ret := _m.Called(ctx, input)

	var r0 auth.Tokens
	if rf, ok := ret.Get(0).(func(context.Context, usecase.UserSignInInput) auth.Tokens); ok {
		r0 = rf(ctx, input)
	} else {
		r0 = ret.Get(0).(auth.Tokens)
	}
